...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="docs/bao_deliverables")
    parser.add_argument("--benchmark-csv", default="docs/hung_deliverables/scalability_benchmark.csv")
    parser.add_argument("--top-clusters-csv", default="docs/hung_deliverables/top_clusters.csv")
    parser.add_argument("--exact-examples-csv", default="docs/hung_deliverables/exact_duplicate_examples.csv")
    parser.add_argument("--near-examples-csv", default="docs/hung_deliverables/near_duplicate_examples.csv")
