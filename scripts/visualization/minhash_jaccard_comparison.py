...
from social_lsh.minhash import hashed_shingles, signature_matrix
...
def main() -> None:
    ...
    parser.add_argument("--output-png", default=str(repo_root / "jupyter" / "output" / "visuals" / "week4_overview.png"))
    parser.add_argument("--summary-json", default=str(repo_root / "jupyter" / "output" / "visuals" / "week4_summary.json"))
    parser.add_argument("--pair-metrics-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week4_pair_metrics.csv"))
    parser.add_argument("--pair-examples-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week4_pair_examples.csv"))
    parser.add_argument("--signature-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week4_signature_matrix.csv"))
