...
from social_lsh.minhash import evaluate_candidates, rank_configs, run_config
...
def main() -> None:
    ...
    parser.add_argument("--output-png", default=str(repo_root / "jupyter" / "output" / "visuals" / "week6_overview.png"))
    parser.add_argument("--summary-json", default=str(repo_root / "jupyter" / "output" / "visuals" / "week6_summary.json"))
    parser.add_argument("--config-results-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week6_config_results.csv"))
    parser.add_argument("--false-positive-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week6_false_positives.csv"))
    parser.add_argument("--false-negative-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week6_false_negatives.csv"))
