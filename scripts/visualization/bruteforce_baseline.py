...
from social_lsh.similarity import exact_jaccard_pairs
...
def main() -> None:
    ...
    parser.add_argument("--output-png", default=str(repo_root / "jupyter" / "output" / "visuals" / "week3_overview.png"))
    parser.add_argument("--summary-json", default=str(repo_root / "jupyter" / "output" / "visuals" / "week3_summary.json"))
    parser.add_argument("--benchmark-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week3_runtime_benchmark.csv"))
    parser.add_argument("--pairs-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week3_baseline_pairs.csv"))
    parser.add_argument("--docs-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week3_baseline_docs.csv"))
