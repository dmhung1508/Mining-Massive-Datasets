...
def main() -> None:
    ...
    parser.add_argument(
        "--us-iran-input",
        default=str(repo_root / "dataset" / "us_iran_war_tweets.csv"),
    )
    ...
    parser.add_argument("--output-png", default=str(repo_root / "jupyter" / "output" / "visuals" / "week8_overview.png"))
    parser.add_argument("--summary-json", default=str(repo_root / "jupyter" / "output" / "visuals" / "week8_summary.json"))
    parser.add_argument("--comparison-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week8_dataset_comparison.csv"))
    parser.add_argument("--russia-pairs-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week8_russia_ukraine_pairs.csv"))
    parser.add_argument("--us-iran-pairs-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week8_us_iran_pairs.csv"))
    parser.add_argument("--cluster-csv", default=str(repo_root / "jupyter" / "output" / "visuals" / "week8_cluster_comparison.csv"))
