...
from uk_russia_lsh.similarity import jaccard_similarity, verify_candidate_pairs
...
def main() -> None:
    ...
    parser.add_argument("--output-png", default=str(repo_root / "datatele" / "week7_overview.png"))
    parser.add_argument("--summary-json", default=str(repo_root / "datatele" / "week7_summary.json"))
    parser.add_argument("--candidate-csv", default=str(repo_root / "datatele" / "week7_candidates.csv"))
    parser.add_argument("--verified-csv", default=str(repo_root / "datatele" / "week7_near_duplicates.csv"))
    parser.add_argument("--clusters-csv", default=str(repo_root / "datatele" / "week7_clusters.csv"))
    parser.add_argument("--validation-csv", default=str(repo_root / "datatele" / "week7_cluster_validation.csv"))
