...
from uk_russia_lsh.datasets import (
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-png",
        default=str(repo_root / "datatele" / "week2_overview.png"),
    )
    parser.add_argument(
        "--summary-json",
        default=str(repo_root / "datatele" / "week2_summary.json"),
    )
    parser.add_argument(
        "--preview-csv",
        default=str(repo_root / "datatele" / "week2_preprocessing_sample.csv"),
    )
    parser.add_argument(
        "--matrix-csv",
        default=str(repo_root / "datatele" / "week2_similarity_matrix.csv"),
    )
