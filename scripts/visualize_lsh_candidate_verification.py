...
from uk_russia_lsh.minhash import generate_candidate_pairs, hashed_shingles, signature_matrix
...
def main() -> None:
    ...
    parser.add_argument("--output-png", default=str(repo_root / "datatele" / "week5_overview.png"))
    parser.add_argument("--summary-json", default=str(repo_root / "datatele" / "week5_summary.json"))
    parser.add_argument("--candidate-csv", default=str(repo_root / "datatele" / "week5_candidates.csv"))
    parser.add_argument("--verified-csv", default=str(repo_root / "datatele" / "week5_verified_pairs.csv"))
    parser.add_argument("--exact-pairs-csv", default=str(repo_root / "datatele" / "week5_exact_pairs.csv"))
