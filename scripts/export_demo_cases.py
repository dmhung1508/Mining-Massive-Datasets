...
from uk_russia_lsh.artifacts import artifact_path, ensure_artifact_dir, read_dataframe
from uk_russia_lsh.constants import DEFAULT_ARTIFACT_DIR
...
def main() -> None:
    ...
    outputs = {
        "top_clusters": output_dir / "week11_top_clusters.csv",
        "exact_pairs": output_dir / "week11_exact_duplicate_examples.csv",
        "near_pairs": output_dir / "week11_near_duplicate_examples.csv",
        "report": output_dir / "week11_demo_cases.md",
    }
