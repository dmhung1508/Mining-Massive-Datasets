...
- Dung `docs/bao_week9_12/similarity_histogram.png` de trinh bay phan bo similarity.
- Nhan manh nguong xac minh Jaccard >= 0.8.

## Slide 4 - Cluster graph
- Dung `docs/bao_week9_12/cluster_graph.png` de mo ta cau truc cum.
- Chi ra so component va component lon nhat.

## Slide 5 - Scalability and runtime
- Dung `docs/bao_week9_12/performance_dashboard.png` de so sanh hieu nang.
- Ket luan: brute-force chi hop cho subset, LSH moi scale duoc.

## Slide 6 - Top cluster examples
- Nguon bang: `docs/hung_week9_12/week11_top_clusters.csv`
- Chon 2-3 cum co y nghia de minh hoa story.

## Slide 7 - Exact duplicate demo
- Nguon bang: `docs/hung_week9_12/week11_exact_duplicate_examples.csv`
- Giai thich vi sao Jaccard = 1.0 va tai sao can dedup.

## Slide 8 - Near duplicate demo
- Nguon bang: `docs/hung_week9_12/week11_near_duplicate_examples.csv`
