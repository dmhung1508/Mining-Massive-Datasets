...
- Artifact directory: `jupyter/output/lsh_combined`
- Metrics: `jupyter/output/lsh_combined/metrics.json`
- Search index: `jupyter/output/lsh_combined/search_index.pkl`
